...
<?php echo form_open('admin/product/edit/update/'.$pro_id , array('id' => 'form','class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
...
<section class="panel">
        ...
        <div class="row">
                ...
                <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="company"  class="form-control valid" required  data-plugin-selectTwo>
                                                              
                                                                    <?php foreach ($company as $row) :?>
                                                                        <option value="<?php echo $row['company_id'] ?>"
                                                                             <?php if ($row['company_id'] == $product_edit[0]['company_id']) {
                                                                                echo "selected";
                                                                                } ?>
            ...
            <div class="col-md-12" style="border:solid 3px #e0e0e0;">
                ...
                <div class=" row">
                                    ...
                                    <div class="col-sm-4 images" id="image-<?php echo $i ?>">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="input-append hidden">
                                               ...
                                               <div style="padding-bottom: 4px "></div>
                                                <img class="img" id="img-image-<?php echo $i ?>" src="<?php echo base_url().$this->upload_path  ?>/product_images/<?php if($image['pro_image'] <> '' ){ echo $image['pro_image']; }else{ echo 'image.png'; } ?>"   />
                                                 <!-- <span class="remove_img_preview" id="remove-image" data-id="<?php echo $i ?>"></span> -->
                                                 <div style="padding-bottom: 4px "></div>
                                    ...
                                    <div class="col-sm-4 images" id="image-<?php echo $y ?>">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="input-append hidden">
                                               ...
                                               <div style="padding-bottom: 4px "></div>
                                                <img class="img" id="img-image-<?php echo $y ?>" src="<?php echo base_url().$this->upload_path ?>/product_images/image.png"   />
                    ...
                    <div class="col-md-4"  >
                        <img  id="img-feature" src="<?php echo base_url().$this->upload_path ?>/product_features/<?php echo $product_edit[0]['pro_feature'] ?>" alt="feature" height="300" width="100%" />
                    </div>
    ...
    <footer class="panel-footer">
        <div class="row">
            <div class="col-sm-12">
                <div class="pull-left">
                    <a href="<?php echo site_url() ?>admin/product/list/<?php if( $product_edit[0]['pro_status']=='Y'){ echo 'active';}else{ echo 'deleted';} ?>" class="btn btn-default">Back</a>
                </div>
