...
<?php echo form_open('admin/category/sub1/add/save' , array('id' => 'form','class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
...
<section class="panel">
 ...
 <footer class="panel-footer">
        <div class="row">
            <div class="col-sm-12">
                <div class="pull-left">
                    <a href="<?php echo site_url() ?>admin/product/sub1/list/active" class="btn btn-default">Back</a>
                </div>
