							...
							<section class="panel">
								<div class="panel-body">
									<div class="thumb-info mb-md">
										<img src="<?php echo base_url() ?>public/assets/images/!logged-user.jpg" class="rounded img-responsive" alt="John Doe">
										...
										<ul class="simple-user-list">
											<li>
												<figure class="image rounded">
													<img src="<?php echo base_url() ?>public/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle">
												</figure>
											...
											<li>
												<figure class="image rounded">
													<img src="<?php echo base_url() ?>public/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle">
												</figure>
											...
											<li>
												<figure class="image rounded">
													<img src="<?php echo base_url() ?>public/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle">
												</figure>
									...
									<ul class="simple-post-list">
										<li>
											<div class="post-image">
												<div class="img-thumbnail">
													<a href="#">
														<img src="<?php echo base_url() ?>public/assets/images/post-thumb-1.jpg" alt="">
													</a>
												</div>
											</div>
											<div class="post-info">
										...
										<li>
											<div class="post-image">
												<div class="img-thumbnail">
													<a href="#">
														<img src="<?php echo base_url() ?>public/assets/images/post-thumb-2.jpg" alt="">
													</a>
												</div>
											</div>
											<div class="post-info">
										...
										<li>
											<div class="post-image">
												<div class="img-thumbnail">
													<a href="#">
														<img src="<?php echo base_url() ?>public/assets/images/post-thumb-3.jpg" alt="">
													</a>
												</div>
											</div>
											<div class="post-info">
													...
													<li>
														<div class="tm-box">
															...
															<div class="thumbnail-gallery">
																<a class="img-thumbnail lightbox" href="<?php echo base_url() ?>public/assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																	<img class="img-responsive" width="215" src="<?php echo base_url() ?>public/assets/images/projects/project-4.jpg">
																	<span class="zoom">
