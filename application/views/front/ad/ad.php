...
<div class="container">
	<div class="title">
			...
			<li class="active"><i>2</i> Select a Category</li>
			<li class=""><i>3</i> Description</li>
...
<!-- Miller container -->
	<div class="miller-container" data-source="html">				
		...
		<ul>
			...
			$category = $this->ad->get_category(); 
			$category_sub1 = $this->ad->get_category_sub1(); 
			$category_sub2 = $this->ad->get_category_sub2();

			foreach ($category as $cat) { ?>
			 	
			<li>
				<a> <?php echo $cat['pro_cat_name']  ?></a>				
				<ul>

					<?php foreach ($category_sub1 as $sub1 ) { 

						if ($cat['cat_id'] == $sub1['cat_id']) { ?>


								<li>
									<a><?php echo $sub1['subcat_name']  ?></a>
									<ul>

													<?php foreach ($category_sub2 as $sub2 ) { 

													if ($sub1['sub_cat1_id'] == $sub2['sub_cat1_id']) { ?>

														
															<li>
																<a href="<?php echo site_url('ad/category/'.$sub2['subcat2_id']) ?>"><?php echo $sub2['subcat_name']  ?></a>
...
?>
	...
	<script src="<?php echo base_url() ;?>public/scripts/handlebars.js"></script>
